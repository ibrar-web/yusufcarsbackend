...
export class BlogEntityCreated1766574222148 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "blogs" ADD CONSTRAINT "FK_df0ace761552cf45be9a3724dc4" FOREIGN KEY ("author_admin_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "blogs" ADD CONSTRAINT "FK_23894b0eefebe5cb62c38484fdc" FOREIGN KEY ("author_supplier_id") REFERENCES "suppliers"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "blogs" DROP CONSTRAINT "FK_23894b0eefebe5cb62c38484fdc"`);
        await queryRunner.query(`ALTER TABLE "blogs" DROP CONSTRAINT "FK_df0ace761552cf45be9a3724dc4"`);
