...
export class Supplierupdated1766479838431 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "suppliers" DROP COLUMN "contactPostcode"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "suppliers" ADD "categories" text NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "suppliers" ADD "contactPostcode" character varying NOT NULL`,
    );
    await queryRunner.query(
