...
export class Initial1766412389213 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_7ef2e28b495d09a4eb28997c65" ON "service_categories" ("name") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_88a33271b3d94a0c4bc14db3b7" ON "service_categories" ("slug") `,
    );
    await queryRunner.query(
      `CREATE TABLE "service_subcategories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "slug" character varying NOT NULL, "description" text, "sortOrder" integer NOT NULL DEFAULT '0', "categoryId" uuid, CONSTRAINT "PK_337616522b494868583e2cbd8c6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_59c25d25e10bd01271a5510755" ON "service_subcategories" ("name") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_3ac4cc1550b373959829685f67" ON "service_subcategories" ("slug") `,
    );
    await queryRunner.query(
      `CREATE TABLE "service_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "slug" character varying NOT NULL, "description" text, "metadata" json, "subcategoryId" uuid, CONSTRAINT "UQ_3948a26869da4755ef82ebf6c63" UNIQUE ("slug"), CONSTRAINT "PK_7383c18e3c8e4956860b117728a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_aee954af2fc59ae659d3c4c34d" ON "service_items" ("name") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_3948a26869da4755ef82ebf6c6" ON "service_items" ("slug") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."quote_requests_requesttype_enum" AS ENUM('local', 'national')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."quote_requests_status_enum" AS ENUM('pending', 'expired', 'accepted')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "reviews_ratings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "rating" integer NOT NULL DEFAULT '0', "comment" text, "isFlagged" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid NOT NULL, "supplierId" uuid NOT NULL, "orderId" uuid, CONSTRAINT "PK_f133329e988d1319202547e35a8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_8cac6c34b1a64e2b79a093c20f" ON "reviews_ratings" ("orderId", "userId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c9c2fcdbbc4e8e82cdfe7ab040" ON "reviews_ratings" ("rating") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."reports_subject_enum" AS ENUM('user', 'supplier', 'quote_request', 'quote_offer', 'order', 'other')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."reports_status_enum" AS ENUM('open', 'in_review', 'resolved', 'rejected')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_d6b03ee0c4629f5b2b722f3189" ON "reports" ("subject") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "quote_request_service_items" ("quote_request_id" uuid NOT NULL, "service_item_id" uuid NOT NULL, CONSTRAINT "PK_3d16009318d255712661ec6da24" PRIMARY KEY ("quote_request_id", "service_item_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_f2c0ba5f70725f7a8c16f68a7f" ON "quote_request_service_items" ("quote_request_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_58b282d496c97a5db8855d3a00" ON "quote_request_service_items" ("service_item_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "service_subcategories" ADD CONSTRAINT "FK_ba9a799fe8faca8d6710b3549d0" FOREIGN KEY ("categoryId") REFERENCES "service_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_items" ADD CONSTRAINT "FK_4ee0ae3d3f388d96e81d1974f39" FOREIGN KEY ("subcategoryId") REFERENCES "service_subcategories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "reviews_ratings" ADD CONSTRAINT "FK_97e140b6344b9cb160085adc822" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "reviews_ratings" ADD CONSTRAINT "FK_78a457a13b34c7e90b3877e9540" FOREIGN KEY ("supplierId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "reviews_ratings" ADD CONSTRAINT "FK_b5942df2b0655f57122abc0f6b1" FOREIGN KEY ("orderId") REFERENCES "orders"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "reports" ADD CONSTRAINT "FK_0571d3b9ed020680a430ad36ae3" FOREIGN KEY ("assignedAdminId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "quote_request_service_items" ADD CONSTRAINT "FK_f2c0ba5f70725f7a8c16f68a7f2" FOREIGN KEY ("quote_request_id") REFERENCES "quote_requests"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "quote_request_service_items" ADD CONSTRAINT "FK_58b282d496c97a5db8855d3a00d" FOREIGN KEY ("service_item_id") REFERENCES "service_items"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "quote_request_service_items" DROP CONSTRAINT "FK_58b282d496c97a5db8855d3a00d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "quote_request_service_items" DROP CONSTRAINT "FK_f2c0ba5f70725f7a8c16f68a7f2"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "reports" DROP CONSTRAINT "FK_0571d3b9ed020680a430ad36ae3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reports" DROP CONSTRAINT "FK_4353be8309ce86650def2f8572d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reviews_ratings" DROP CONSTRAINT "FK_b5942df2b0655f57122abc0f6b1"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reviews_ratings" DROP CONSTRAINT "FK_78a457a13b34c7e90b3877e9540"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reviews_ratings" DROP CONSTRAINT "FK_97e140b6344b9cb160085adc822"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "service_items" DROP CONSTRAINT "FK_4ee0ae3d3f388d96e81d1974f39"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_subcategories" DROP CONSTRAINT "FK_ba9a799fe8faca8d6710b3549d0"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_58b282d496c97a5db8855d3a00"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f2c0ba5f70725f7a8c16f68a7f"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d6b03ee0c4629f5b2b722f3189"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c9c2fcdbbc4e8e82cdfe7ab040"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8cac6c34b1a64e2b79a093c20f"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3948a26869da4755ef82ebf6c6"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_aee954af2fc59ae659d3c4c34d"`,
    );
    await queryRunner.query(`DROP TABLE "service_items"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3ac4cc1550b373959829685f67"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_59c25d25e10bd01271a5510755"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7ef2e28b495d09a4eb28997c65"`,
    );
