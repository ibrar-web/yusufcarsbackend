...
export class Migrations1767599462870 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."orders_status_enum" AS ENUM('in_transit', 'reported', 'reviewed', 'completed', 'cancelled')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "blogs" ADD CONSTRAINT "FK_d4654b46ef5d90a755615005249" FOREIGN KEY ("publisher_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "blogs" DROP CONSTRAINT "FK_d4654b46ef5d90a755615005249"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."orders_status_enum_old" AS ENUM('in_transit', 'completed', 'cancelled')`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ALTER COLUMN "status" DROP DEFAULT`,
    );
